...
def drop_quantizer_keys(state_dict):
    # no longer used; kept for backward compatibility if needed elsewhere
...
def main():
    ...
    cache_name = "tsne_cache_vq_class{}_len_between_{}_{}.npz".format(
        classes_tag,
        int(args.min_len),
        int(args.max_len),
    )
    ...
    print("[Cache] saved t-SNE cache to {}".format(cache_path))
